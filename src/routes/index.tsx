        ...
        <div className="glass space-y-6 rounded-3xl p-6 md:p-8">
          ...
          <div className="space-y-2">
            <Textarea
              ...
              className="bg-background/50 border-border/50 focus-visible:ring-primary/30 h-[200px] max-h-[200px] min-h-[200px] resize-none overflow-y-auto rounded-2xl text-base"
            />
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {PRESENTATION_TEMPLATES.map((template) => (
              <button
                ...
                className="border-border/50 bg-card/50 text-muted-foreground hover:text-foreground hover:border-primary/50 hover:bg-primary/5 rounded-full border px-4 py-2 text-sm transition-all"
              >
                {template.label}
              </button>
            ))}
